> **Archived.** UI design for the Textual TUI that the web UI replaced in 1.0.0; the current UI is described in `docs/UI.md`. Kept as a historical record; the code and the reference docs in `docs/` are authoritative.
