> **Archived.** Handoff notes for Phase 1 of the authoring and composition plan, shipped in 2.0.0. Kept as a historical record; the code and the reference docs in `docs/` are authoritative.
