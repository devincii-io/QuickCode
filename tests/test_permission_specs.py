...
AUDITED = {
    ...
    # Read or stop a background job this conversation started, by its own id
    # (never a pid): gated where the job was started, through bash's spec.
    "bash_output": (False, "bash_id", False, False),
    "bash_kill": (False, "bash_id", False, False),
